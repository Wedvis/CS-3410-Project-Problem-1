...
public class Test_CollisionResolution {
    public static void main(String[] args) {
        ...
        File dblTest_probe = new File("src/group_project/dblTest_probe.txt");
        ...
        if (doesExist) {
            try {
                ...
                PrintWriter writer = new PrintWriter(dblTest_probe);
                writer.println("valCount,probes");
                input.next();
                ...
                while (input.hasNext()) {
                    ...
                    if (Double.parseDouble(line[4]) > -7) {
                        test.put(0, line[0]);
                        writer.println(test.valCount + "," + test.probes_put);
