...
public class Test_Hashfunction {
    public static void main(String args[]) {
        ...
        File fnv_size11 = new File("src/group_project/fnv_size11.txt"); //note, ignore variable name, change the file name in URL to reflect data being produced
                    ...
                    String[] line = input.next().split(",");
                     test.put(0, line[0]);
                        ...
                        if(test.valCount >= (test.array.length/2)) {
                            test.resizePrime(); //change to resize(test.array.length * 2) for non prime resizes
                        }
                    }
                }
